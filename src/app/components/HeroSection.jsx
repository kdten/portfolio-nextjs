      ...
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          <div>
            <Link
              href="/#contact"
              className="px-6 inline-block py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-primary-500 to-secondary-500 betterhover:hover:bg-slate-200 text-white"
            >
              Hire Me
            </Link>
            ...
            <Dropdown>
              <DropdownTrigger>
                <Button
                  auto
                  className="px-1 py-1 inline-block w-full sm:w-fit rounded-full bg-gradient-to-br from-primary-500 to-secondary-500 betterhover:hover:bg-slate-800 text-black dark:text-white mt-3"
                >
                  <span className="block bg-[#f0f0f0] dark:bg-[#121212] betterhover:hover:bg-slate-300 dark:betterhover:hover:bg-slate-800 rounded-full px-5 py-2">
                    Download CV
                  </span>
                </Button>
              </DropdownTrigger>
