...
<Link href="https://github.com/kdten/">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48" height="48" fill="currentColor" className="text-black dark:text-white betterhover:hover:text-gray-500 dark:betterhover:hover:text-gray-500">
      {/* SVG path goes here */}
...
<Link href="https://www.linkedin.com/in/koltenedward/">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="48" height="48" fill="currentColor" className="text-black dark:text-white betterhover:hover:text-[#0077b5] dark:betterhover:hover:text-[#0077b5]">
      {/* SVG path goes here */}
...
<Link href="mailto:koltenedward@proton.me">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="16 -20 96 115" width="64" height="38" fill="currentColor" className="text-black dark:text-white betterhover:hover:text-gray-500 dark:betterhover:hover:text-gray-500">
      ...
      <div>
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              className="bg-primary-500 betterhover:hover:bg-primary-600 text-white font-medium py-2.5 px-5 rounded-lg w-full"
            >
              Send Message
            </button>
          </form>
