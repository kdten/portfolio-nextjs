...
<Link href="https://github.com/kdten/">
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width="48" height="48" fill="currentColor" className="text-black dark:text-white hover:text-[#dddddd] dark:hover:text-[#dddddd]">
      {/* SVG path goes here */}
